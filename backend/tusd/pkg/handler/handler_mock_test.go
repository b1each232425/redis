...
func (m *MockFullDataStore) Query(ctx context.Context, criteria string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockFullDataStoreMockRecorder) Query(ctx, criteria interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Query", reflect.TypeOf((*MockFullDataStore)(nil).Query), ctx, criteria)
}
