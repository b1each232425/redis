...
var (
	...
	filenameReservedRegex             = regexp.MustCompile(`[\x5F'<>:"/\\|?*\x00-\x1F]`)
	filenameReservedWindowsNamesRegex = regexp.MustCompile(`(?i)^(con|prn|aux|nul|com[0-9]|lpt[0-9])$`)
)

func FilenamifyV2(str string, optFuns ...func(options *NamifyOptions)) (string, error) {
	options := NamifyOptions{
...
func Filenamify(str string, options NamifyOptions) (string, error) {
	return FilenamifyV2(str, genFuncFromOptions(options))
}

func PathV2(filePath string, optFuns ...func(options *NamifyOptions)) (string, error) {
...
func Path(filePath string, options NamifyOptions) (string, error) {
...
func genFuncFromOptions(options NamifyOptions) func(*NamifyOptions) {
	var optFun = func(opt *NamifyOptions) {
